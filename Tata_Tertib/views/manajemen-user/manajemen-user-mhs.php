    ...
    <div class="main-content">
        ...
        <div class="table-container">
            <div class="d-flex flex-row justify-content-between align-items-center p-4 pb-0">
                <h1 class="m-0 p-0">List User Mahasiswa</h1>
                <a href="/tambahUserMhs" class="btn btn-primary">Tambah Mahasiswa</a>
            </div>
            <!-- toggle button untuk navigasi table -->
            <div class="table-nav" data-toggle="buttons">
                <ul id="tab-nav">
                    <a href="/manajemenUserMhs">
                        <li class="nav-table-button active" id="btn-mhs"><img src="assets/icon/student-icon.svg" class="icon" style="opacity: 1;" alt="">Mahasiswa</li>
                    </a>
            ...
            <div class="line">
                <div class="line-active" id="line-active" style="width:165.02px; margin-left:0px;"></div>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $tabelMahasiswa[$i]["id_kelas"]; ?></td>
                                    <td><?php echo $tabelMahasiswa[$i]["alamat"]; ?></td>
                                    <td><?php echo $tabelMahasiswa[$i]["no_telp"]; ?></td>
                                    <td>
