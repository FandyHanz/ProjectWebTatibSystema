...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-container" style="overflow-y:auto;">
            <a href="<?=getHeader($level)?>" ?>> <img src="../../assets/icon/x.svg" class="justify-self-end rounded-circle mt-3" style="position:absolute; right: 40px; width:20px;height:20px; font-size:10px; justify-content:center; justify-items:center; cursor:pointer; z-index:3; border-radius: 40px"></xrc=""></a>
