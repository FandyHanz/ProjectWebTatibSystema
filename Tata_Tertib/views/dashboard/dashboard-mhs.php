    ...
    <div class="main-content">
        ...
        <div class="table-container">
            ...
            <div class="table-nav" data-toggle="buttons">
                <ul id="tab-nav">
                    <li class="nav-table-button active"><a href="#Mahasiswa"><img src="../../assets/icon/student-icon.svg" class="icon" style="opacity: 1;" alt=""><span class="title-btn">Pelanggaran Pribadi</span class="title-btn"></a></li>
                </ul>
            </div>
            <div class="line">
                <div class="line-active" style="width: 243px;" id="line-active"></div>
            </div>
            ...
            <div id="table-content-container" class="table-content-container">
                ...
                <?php include 'mhs-table-pribadi.php';?>
            </div>
        </div>
