...
<div class="d-flex justify-content-center align-items-center flex-column" style="width: 100%; height: 100%;">
    ...
    <!-- Input dan Dropdown -->
    <h1 id="title" class="mb-4" style="font-size: 35px;">Masukkan Data Karyawan</h1>

    <form action="../../action/report/report-karyawan-redirect.php" class="d-flex flex-column justify-content-center align-items-center">
