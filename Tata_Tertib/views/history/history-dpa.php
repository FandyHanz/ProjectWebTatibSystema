        ...
        <div class="table-container">
            ...
            <div class="table-nav" data-toggle="buttons">
                <ul id="tab-nav">
                    ...
                    <li class="nav-table-button"><a href="#Dosen"><img src="../../assets/icon/teacher-icon.svg" class="icon" style="opacity: 1;" alt=""><span class="title-btn">Pribadi</span class="title-btn"></a></li>
                </ul>
            </div>
            <div class="line">
